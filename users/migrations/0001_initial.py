    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('company', 'Company'), ('trainer', 'Trainer'), ('reviewer', 'Reviewer')], default='trainer', max_length=10)),
                ('staked_amount', models.DecimalField(decimal_places=6, default=0, max_digits=18)),
